...
const Index = () => {
      ...
      case 'more_info':
        return (
          <Button 
            ...
            className="w-full h-8 text-xs" 
            size="sm"
            onClick={() => navigate(`/products/${product.id}`)} // Navigate to detail page for info
          >
  ...
  return (
    <Layout>
      {/* Hero Section - Always rendered, but content is dynamic */}
      <HeroSlideshow />

      {/* Features Section */}
      {homepageSections.featuresSection && (
      ...
      {/* Featured Products */}
      {homepageSections.featuredProductsSection && (
      ...
      {/* Categories Preview */}
      {homepageSections.categoriesPreviewSection && (
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">
              Shop by Category
